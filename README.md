...
If you don't want to rely on my CLIENT_ID go get yourself one [here](https://dev.twitch.tv/console/apps) and replace the part after client_id in [widget.js](widget.js) with your new CLIENT_ID.
